...
<html lang="en">
  ...
  <body class="ficha-hotel">
    ...
    <div class="c2-c3__container ficha-galeria">
      <?php $include_no = true; include("../modules/c2-c3-ficha-privilege.php"); ?>
    </div>
    ...
    <?php $include_no = true; include("../modules/c6-ficha-privilege.php"); ?>
    <?php $include_no = true; include("../modules/c10-ficha-privilege.php"); ?>
    <?php $include_no = true; include("../modules/c17-ficha-privilege.php"); ?>
