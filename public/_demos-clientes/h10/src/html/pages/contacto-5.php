...
<html lang="en">
  ...
  <body>
    ...
    <?php $include_no = true; include("../modules/c6-contacto.php"); ?>

    <div class="interior_header">
      <?php $include_no = true; include("../sprint-4/c7.php"); ?>
    </div>

    <?php $include_no = true; include("../sprint-4/c32-e2.php"); ?>

    <?php $include_no = true; include("../sprint-1/footer_contacto.php"); ?>
