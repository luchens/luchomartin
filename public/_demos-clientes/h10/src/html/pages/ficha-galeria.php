...
<html lang="en">
  <head>
    ...
    <title>Hotel - Galería</title>
    <link rel="shortcut icon" href="../../../src/icons/favicon.ico" type="image/vnd.microsoft.icon" />
    <link rel="stylesheet" href="../../../css/style-ficha-galeria.css">
  </head>
  <body class="ficha-hotel">
    <?php $include_no = true; include("../sprint-2/c1-topbar-main.php"); ?>
    <div class="c2-c3__container ficha-galeria">
      <?php $include_no = true; include("../modules/c2-c3-ficha-galeria.php"); ?>
    </div>
    <div class="c62__container buscador-avanzado ficha-galeria is-hidden">
      <div class="container-fix">
      <?php include("../modules/c7-ficha-tabs.php"); ?>
      </div>
    </div>

    <?php $include_no = true; include("../sprint-2/c6.php"); ?>

    <section class="c51-02__container first">
      <div class="titulo">El hotel</div>
      <?php $include_no = true; include("../sprint-4/c51-02.php"); ?>
    </section>

    <section class="c51-02__container">
      <div class="titulo">Habitaciones</div>
      <?php $include_no = true; include("../sprint-4/c51-02-solo-imagenes.php"); ?>
    </section>

    <section class="c51-02__container">
      <div class="titulo">Restaurantes y bares</div>
      <?php $include_no = true; include("../sprint-4/c51-02-solo-imagenes.php"); ?>
    </section>
