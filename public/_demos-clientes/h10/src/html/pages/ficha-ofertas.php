...
<html lang="en">
  ...
  <body class="ficha-hotel">
    ...
    <?php $include_no = true; include("../modules/c6-ficha-ofertas.php"); ?>
    <?php $include_no = true; include("../sprint-4/c56.php"); ?>
    <?php $include_no = true; include("../modules/c30-a-ofertas.php"); ?>
    <?php
    $include_no = true; include("../modules/c69-ficha-ofertas.php");
    ?>
    <?php $include_no = true; include("../modules/c30-a-ofertas1.php"); ?>

    <?php
    //$include_no = true; include("../modules/c69-ficha-ofertas-5-elems.php");
    ?>
    <?php
    $include_no = true; include("../modules/c18-ficha-ofertas.php");
    ?>
