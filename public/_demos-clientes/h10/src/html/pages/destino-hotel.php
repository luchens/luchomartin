...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="../../../css/style-destino-hotel.css">
  </head>
  <body>
    ...
    <?php $include_no = true; include("../modules/c6-destino-hotel.php"); ?>

    <div class="interior_header margin-0">
      <?php $include_no = true; include("../sprint-4/c7.php"); ?>
    </div>

    <?php $include_no = true; include("../modules/c66-destino-hotel.php"); ?>
    <?php $include_no = true; include("../modules/c50-destino-hotel.php"); ?>
    ...
    <div class="grid_left_lateral container-fix">
      ...
      <?php $include_no = true; include("../modules/c25-destino-hotel.php"); ?>
      </div>
    </div>

    <?php $include_no = true; include("../modules/c78-destino-hotel.php"); ?>
