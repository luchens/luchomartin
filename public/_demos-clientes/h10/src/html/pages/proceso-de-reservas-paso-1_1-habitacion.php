...
<html lang="en">
  <head>
    ...
    <title>Proceso de Reservas - Paso 1</title>
  ...
  <body class="proceso-de-reservas paso-1">
    ...
    <section class="container_">
        ...
        <div class="container-fix">
          <div class="container-left">
            ...
            <div class="data">
              ...
              <a href="#" class="btn-link">IR A LA FICHA DEL HOTEL<img class="arrow-right" src="../../icons/arrow-right.svg" alt="hotel image"></a>
            </div>
          </div>
      ...
      <div class="proceso-buscador">
        <!--<div class="container"><a href="/src/html/pages/home.php"><img src="../../logos/logo-blue.svg" class="logo"></a></div>-->
        <?php $include_no = true; include("../sprint-4/c7d.php"); ?>
      </div>
    ...
    <div class="menu-bottom-mobile">
      <a href="#" class="btn-link-top"><img src="../../icons/arrow_big_down.svg" alt="" /></a>
      <a href="#" class="btn-back-top"><img src="../../icons/arrow-down-white.svg" alt="" /></a>
      <div class="holder fix-h">
        <div class="title-top">
          <div class="holder-top">
            <div class="title">Detalle reserva</div>
            <div class="btns">
              <a href="#" class="btn-call"><img src="../../icons/call_.svg" alt="" /></a>
              <a href="#" class="btn-close"><img src="../../icons/menu-close.svg" alt="" /></a>
            </div>
          </div>
        </div>
        ...
        <div class="acordeon">
          ...
          <div class="item">
            <div class="item-title show">Mi reserva</div>
            <div class="item-content holder-top">
              ...
              <div class="holder-detalles">
                ...
                <div class="detalle">
                  ...
                  <div class="row bottom">
                    <div class="col-left">
                      <div class="texto">8 personas, 4 días</div>
                    </div>
                    <div class="col-right">
                ...
                <div class="detalle">
                  ...
                  <div class="row bottom">
                    <div class="col-left">
                      <div class="texto">2 vehículos, 4 días</div>
                    </div>
                    <div class="col-right">
                ...
                <div class="detalle">
                  ...
                  <div class="row bottom">
                    <div class="col-left">
                      <div class="texto">16 sesiones</div>
                    </div>
                    <div class="col-right">
      ...
      <div class="row">
        ...
        <button type="button" class="btn-continuar estado-continuar">CONTINUAR</button>
          ...
          <a href="#" class="btn-link texto-msj">Falta añadir habitaciones para continuar</a>
        </div>
      </div>
    </div>
    ...
    <div class="menu-mobile">
      <div class="row">
        <a href="#" class="btn-volver"><img src="../../icons/arrow_small_left.svg" alt="" /></a>
        <div class="holder">
          <div class="title">Seleccionar habitación</div>
          <div class="text">Reserva. Paso 1/4</div>
        </div>
        <a href="#" class="btn-cerrar"><img src="../../icons/menu-close.svg" alt="" /></a>
      </div>
      <div class="row">
        <div class="holder">
        ...
        <a href="#" class="btn-editar"><img src="../../icons/menu-editar.svg" alt="" /></a>
      </div>
    </div>
    ...
    <section class="container-fix">
      <div class="row-ir">
        <a href="#" class="btn-ir">Ir a la ficha del hotel <img src="../../icons/arrow-right.svg" alt="" /></a>
      </div>
      ...
      <div class="col-left">
        ...
        <div class="habitacion-top">
          <div class="titulo-top">
            <div class="titulo">HABITACIONES SELECCIONADAS</div>
            <div class="texto">3 habitaciones de 4</div>
          </div>
          <div class="habitaciones-holder">

            <!--<div class="habitacion">
              <div class="image">
                <img src="../../images/image-154.png" class="img" />
              </div>
              <div class="data">
                <div class="titulo">
                  1- HABITACIÓN DOBLE VISTA MAR LATERAL
                  <div class="icons">
                    <img src="../../icons/habitacion.svg" class="icon" alt="" />
                    <img src="../../icons/habitacion.svg" class="icon" alt="" />
                    <img src="../../icons/habitacion.svg" class="icon" alt="" />
                    <img src="../../icons/habitacion.svg" class="icon" alt="" />
                  </div>
                </div>
                <div class="texto">1 Cambio gratis, Sólo Alojamiento, <b>Desayuno incluido Club H10</b></div>
                <div class="row-bottom">
                  <div class="btns">
                    <a href="#" class="btn-link">Ver equipamiento</a>
                    <span class="line"></span>
                    <a href="#" class="btn-link">Ver calendario de precios</a>
                  </div>
                  <div class="precio"><span>193€</span> 193€</div>
                </div>
              </div>
            </div>
          ...
          <div class="btn-holder"><a href="#" class="btn-continuar estado-continuar">CONTINUAR</a></div>
        </div>


        <div class="habitaciones estado-no-continuar una_habitacion">
          <div class="habitacion">
            <div class="col">
              <div class="col-left">
                <a href="#" class="btn-modal-trigger">
                  <div class="image-holder">
                    <img src="../../icons/expandir.svg" class="icon btn-modal" alt="" />
                    <img src="../../images/image-154.png" class="image" alt="" />
                  </div>
                </a>
              </div>
              <div class="col-right">
                <div class="title">HABITACIÓN DOBLE VISTA MAR LATERAL</div>
                <div class="labels">
                  <div class="label">VISTAS AL MAR</div>
                  <div class="label">VISTAS AL MAR</div>
                  <div class="label">
                    DESAYUNO GRATIS <img src="../../icons/i.svg" class="icon" alt="" />
                    <div class="tooltip">
                      <img src="../../icons/i.svg" class="ico" alt="" />
                      <div class="texto">Desayuno gratis reservando en la web, seleccionando solo alojamiento</div>
                    </div>
                  </div>
                </div>
                <div class="text">Restaurante buffet que ofrece una cocina de mercado con estaciones temáticas de cocina en vivo y una terraza con espectaculares vistas al mar.</div>
                <div class="btns">
                  <a href="#" class="btn-link">Ver equipamiento</a>
                  <span class="line"></span>
                  <a href="#" class="btn-link">Ver calendario de precios</a>
            ...
            <div class="label-top"><span>SOLO QUEDAN 5 HABITACIONES</span></div>
            <div class="tabla">
              <div class="row top">
                <div class="col"><b>TARIFA</b></div>
                <div class="col"><b>Régimen</b></div>
                <div class="col"><b>OCUPACIÓN</b></div>
                <div class="col"><b>Precio noche*</b></div>
                <div class="col"><b>Precio total*</b></div>
                <div class="col"></div>
              </div>
              <div class="rows">
                <div class="row">
                  <div class="col tit">1 Cambio de fecha gratis<a href="#" class="btn-cambio">(paga ahora)</a></div>
                  <div class="col">Alojamiento con desayuno gratis</div>
                  <div class="col">
                    <div class="icons">
                      <img src="../../icons/habitacion.svg" class="icon" alt="" />
                      <img src="../../icons/habitacion.svg" class="icon" alt="" />
                  ...
                  <div class="col"><div class="precio-alt"><span>193€</span> 386€</div></div>
                  <div class="col"><a href="#" class="btn-link">SELECCIONAR</a></div>
                </div>
                <div class="row">
                  <div class="col"></div>
                  <div class="col">Media Pensión</div>
                  <div class="col">
                    <div class="icons">
                      <img src="../../icons/habitacion.svg" class="icon" alt="" />
                      <img src="../../icons/habitacion.svg" class="icon" alt="" />
                ...
                <div class="row">
                  <div class="col"></div>
                  <div class="col"><a href="#" class="btn-todo">Todo incluido</a></div>
                  <div class="col">
                    <div class="icons">
                      <img src="../../icons/habitacion.svg" class="icon" alt="" />
                      <img src="../../icons/habitacion.svg" class="icon" alt="" />
              ...
              <div class="rows">
                <div class="row">
                  <div class="col tit">Cancelación gratuita<a href="#" class="btn-cancelacion">(pago en el hotel)</a></div>
                  <div class="col">Alojamiento con desayuno gratis</div>
                  <div class="col">
                    <div class="icons">
                      <img src="../../icons/habitacion.svg" class="icon" alt="" />
            ...
            <div class="habitaciones-opcion-mobile">
              <div class="habitacion-opcion">
                <div class="tit">1. Elige una tarifa</div>
                <div class="radiobox-holder">
                  <label class="radiobox">
                    <input type="radio" name="tarifa" checked>
                    <span class="radiomark"></span> <span><b>Un cambio de fecha gratis,</b><br>pagando ahora<br>(desde <u>386€</u> <b>427€</b>/noche)</span>
                  </label>
                </div>
                <div class="radiobox-holder">
                  <label class="radiobox">
                    <input type="radio" name="tarifa">
                    <span class="radiomark"></span> <span><b>Cancelación gratuita,</b><br>pagando en el hotel<br>(desde <u>386€</u> <b>427€</b>/noche)</span>
                  </label>
                </div>
              </div>
              <div class="habitacion-opcion">
                <div class="tit">2. Elige un Régimen</div>
                <div class="radiobox-holder">
                  <label class="radiobox">
                    <input type="radio" name="regimen">
                    <span class="radiomark"></span> <span><b>Alojamiento con desayuno gratis</b></span><span class="prices">(desde <u>386€</u> <b>427€</b>/noche)</span>
                  </label>
                </div>
                <div class="radiobox-holder">
                  <label class="radiobox">
                    <input type="radio" name="regimen">
                    <span class="radiomark"></span> <span><b>Media Pensión</b></span><span class="prices">(desde <u>386€</u> <b>427€</b>/noche)</span>
                  </label>
                </div>
                <div class="radiobox-holder">
                  <label class="radiobox">
                    <input type="radio" name="regimen">
                    <span class="radiomark"></span> <span><b>Todo incluido</b></span><span class="prices">(desde <u>386€</u> <b>427€</b>/noche)</span>
                  </label>
                </div>
              </div>
              <div class="total">
                <span>TOTAL habitación</span>
                <span class="precio">386 €</span>
              </div>
              <a href="#" class="btn-link">Ver condiciones de tarifas y regímenes</a>
              <button type="button" class="btn-seleccionar estado-continuar">SELECCIONAR</button>
              <button type="button" class="btn-seleccionar estado-no-continuar" disabled>SELECCIONAR</button>
            </div>
          </div>
      ...
      <div class="col-right" id="col-right">
        <div class="sticky">
          ...
          <div class="mi-reserva">
            ...
            <a href="#" class="btn-continuar estado-continuar">CONTINUAR</a>
            <div class="estado-no-continuar">
    ...
    <?php include("../pages/proceso-de-reservas-paso-modals.php"); ?>
    ...
    <script type="text/javascript" src="../../../js/proceso-de-reservas.js"></script>
