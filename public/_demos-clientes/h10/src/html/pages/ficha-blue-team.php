...
<html lang="en">
  ...
  <body class="ficha-hotel">
    ...
    <div class="c2-c3__container ficha-galeria">
      <?php $include_no = true; include("../modules/c2-c3-ficha-blue-team.php"); ?>
    </div>
    ...
    <?php $include_no = true; include("../modules/c6-ficha-blue-team.php"); ?>
    <?php $include_no = true; include("../modules/c10-ficha-blue-team.php"); ?>
    <?php $include_no = true; include("../modules/c17-ficha-blue-team.php"); ?>
    ...
    <script type="text/javascript" src="../../../js/_c17-01.js"></script>
