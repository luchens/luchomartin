...
<html lang="en">
  ...
  <body class="ficha-hotel">
    ...
    <?php $include_no = true; include("../modules/c6-ficha-reuniones.php"); ?>
    <?php $include_no = true; include("../modules/c10-ficha-reuniones.php"); ?>
    <?php $include_no = true; include("../modules/c38-ficha-reuniones.php"); ?>
    <?php $include_no = true; include("../sprint-4/c52_B.php"); ?>
    <?php $include_no = true; include("../sprint-4/c79.php"); ?>
    ...
    <script type="text/javascript" src="../../../js/_c52_B.js"></script>
    <script type="text/javascript" src="../../../js/_c10_no_slider.js"></script>
    <script type="text/javascript" src="../../../js/_c17-03.js"></script>
