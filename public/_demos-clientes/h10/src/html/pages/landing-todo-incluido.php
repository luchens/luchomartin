...
<html lang="en">
  ...
  <body>
    ...
    <?php $include_no = true; include("../modules/c6-todo-incluido.php"); ?>

    <div class="interior_header landings">
      <?php $include_no = true; include("../modules/c7-landings.php"); ?>
    </div>

    <?php $include_no = true; include("../modules/c67-todo-incluido.php"); ?>

    <section class="c51-02__container">
      <?php $include_no = true; include("../modules/c51-todo-incluido.php"); ?>
    </section>

    <div class="container-fix">
      <?php $include_no = true; include("../modules/c71-todo-incluido.php"); ?>
    </div>

    <?php $include_no = true; include("../modules/c76-todo-incluido.php"); ?>
