...
<html lang="en">
  <head>
    ...
    <title>Proceso de Reservas - Paso 1 - Skeleton</title>
      ...
      <div class="col-left">
        ...
        <div class="habitacion-top">
          <div class="titulo-top">
            ...
            <div class="texto">1 habitaciones de 4</div>
          </div>
...
<!--          <div class="btn-holder"><a href="#" class="btn-continuar estado-continuar">CONTINUAR</a></div>-->
        ...
        <div class="titulo-top estado-no-continuar">
          <div class="titulo">SELECCIÓN DE HABITACIÓN 2 DE 4</div>
      ...
      <div class="col-right" id="col-right">
        <div class="sticky">
          <div class="conversor-divisas"></div>
          <div class="mi-reserva"></div>
          <div class="ayuda"></div>
        </div>
      </div>
    </section>
