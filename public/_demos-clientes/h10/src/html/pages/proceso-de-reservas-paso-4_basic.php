...
<html lang="en">
  <head>
    ...
    <title>Proceso de Reservas - Paso 4</title>
  ...
  <body class="proceso-de-reservas paso-4">
    ...
    <div class="menu-mobile only-top">
      <div class="row">
        <a href="#" class="btn-volver"></a>
        <div class="holder">
          <div class="title">Confirmación</div>
          <div class="text">Reserva. Paso 4/4</div>
        </div>
        <a href="#" class="btn-cerrar"><img alt='a' src="../../icons/menu-close.svg" alt="" /></a>
      </div>
    </div>

    <div class="notificacion-top">Acabas de <b>ahorrar un 15% (120€)</b> por reservar en nuestra web (Código promo SUMMER22 + Club H10) <a href="#" class="btn-close"></a></div>

    <section class="pasos noti-fix">
      <div class="container">
        <ul class="menu">
          <li>
            <a href="#" class="activo">
    ...
    <section class="container-fix">
      <div class="confirmacion-top">
        <div class="titulo">Gracias Laura, tu reserva ha sido confirmada</div>
        <div class="texto">En breve recibirás en tu email la confirmación de reserva que deberás mostrar en el hotel. Recuerda revisar tu bandeja de correo no deseado.</div>
        <div class="btns">
          <a href="#" class="btn-link"><span>DESCARGAR reserva</span><img alt='a' src="../../icons/file_download.svg" class="icon" alt="" /></a>
          <span class="line"></span>
          <a href="#" class="btn-link"><span>IMPRIMIR reserva</span><img alt='a' src="../../icons/print.svg" class="icon" alt="" /></a>
          <span class="line"></span>
          <a href="#" class="btn-link"><span>VER CONDICIONES DE LA reserva</span><img alt='a' src="../../icons/file_description.svg" class="icon" alt="" /></a>
        </div>
      </div>
    </section>
      ...
      <div class="datos-holder">
          ...
          <div class="hotel-top">
            ...
            <div class="data-holder">
              ...
              <div class="informacion">
                <div class="tit">Información y reservas</div>
                <a href="#">(+34) 900 123 123</a>
                <a href="#">atlanticsunset@h10hotels.com</a>
              </div>
        ...
        <div class="col-right_">
          ...
          <div class="rows">
            ...
            <div class="row"><div class="col-left"><b>Pago<u>: </u></b><span>Tarjeta de crédito / débito</span></div></div>
            <div class="row"><div class="col-left"><b>Observaciones<u>: </u></b><span>Lorem ipsum dolor sit amet lorem ipsum dolor sit amet</span></div></div>
          </div>
          <div class="rows line">
    ...
    <section class="container-fix">
      <div class="habitacion-top fix-width">
        ...
        <div class="habitacion">
          ...
          <div class="data">
            <div class="titulo">
              HABITACIÓN DOBLE VISTA MAR LATERAL
              <div class="icons">
            ...
            <div class="row-bottom">
              <div class="btns">
                <a href="#" class="btn-link-a"><span>Mostrar</span> Desglose <span>de</span> precios</a>
              </div>
              <div class="precio">193€</div>
            </div>
          </div>
        </div>
        <div class="habitacion">
      ...
      <div class="extra-top fix-width mt">
        <div class="titulo-top">
          <div class="titulo">EXTRAS</div>
        </div>
        <div class="extra">
          <div class="image">
            <img alt='a' src="../../images/image-155.png" class="img" />
          </div>
          <div class="data">
            <div class="titulo"> DESAYUNO GRATIS <div class="texto"></div></div>
        ...
        <div class="extra">
          <div class="image">
            <img alt='a' src="../../images/image-157.png" class="img" />
          </div>
          <div class="data">
            <div class="titulo">PARKING <div class="texto"></div></div>
            <div class="texto">10/04/2023 al 15/04/2023 - 1 x 10,0€</div>
            <div class="row-bottom">
              <div class="btns">
                <a href="#" class="btn-link-a"><span>Mostrar</span> Desglose <span>de</span> precios</a>
        ...
        <div class="extra">
          <div class="image">
            <img alt='a' src="../../images/image-158.png" class="img" />
          </div>
          <div class="data">
            <div class="titulo">Tratamiento en nuestro Despacio Spa <div class="texto"></div></div>
            <div class="texto">10/04/2023 al 15/04/2023 - 1 x 10,0€</div>
            <div class="row-bottom">
              <div class="btns">
                <a href="#" class="btn-link-a"><span>Mostrar</span> Desglose <span>de</span> precios</a>
          ...
          <div class="data">
            <div class="importe">
              ...
              <div class="row">
                ...
                <div class="texto-pie"><a href="#" class="btn-impuestos">*Impuestos incluidos excepto impuestos pernoctación</a></div>
              </div>
            </div>
          </div>
        </div>
