...
<html lang="en">
  ...
  <body>
    ...
    <?php $include_no = true; include("../modules/c6-cookies.php"); ?>

    <div class="margin-0">
      <?php $include_no = true; include("../sprint-4/c7.php"); ?>
    </div>

    <div class="grid_right_lateral container-fix">
      <div class="central_body">
      <?php $include_no = true; include("../sprint-4/c46.php"); ?>
      </div>
      <div class="right_lateral">
      <?php $include_no = true; include("../sprint-4/c48.php"); ?>
      </div>
    </div>

    <div class="container-fix">
      <?php $include_no = true; include("../modules/c46-cookies.php"); ?>
      <?php $include_no = true; include("../modules/c57-cookies.php"); ?>
      <?php $include_no = true; include("../sprint-4/c47.php"); ?>
    </div>
    ...
    <script type="text/javascript" src="../../../js/_c48.js"></script>
