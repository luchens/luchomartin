...
<html lang="en">
  <head>
    ...
    <title>Proceso de Reservas - Paso 3 - Skeleton</title>
  ...
  <body class="proceso-de-reservas paso-3 ini-skeleton">
    ...
    <section class="pasos">
      <div class="container">
        <ul class="menu">
          ...
          <li>
            <a href="/src/html/pages/proceso-de-reservas-paso-2.php" class="activo">
              <span class="numero">2</span>
              <div class="nombre">EXTRAS</div>
            </a>
          </li>
          <li>
            <a href="/src/html/pages/proceso-de-reservas-paso-3.php" class="activo">
    ...
    <div class="menu-mobile">
      <div class="row">
        ...
        <div class="holder">
          <div class="title">Detalles y pago</div>
          <div class="text">Reserva. Paso 3/4</div>
        </div>
    ...
    <section class="container-fix extra-p-top">
      <div class="row-ir">
      ...
      <div class="col-left">
        <div class="extra-top">
          ...
          <div class="mensaje-descuento">
            <div class="col-left">
              <img alt='a' src="../../logos/club-h10.svg" class="logo" />
            </div>
            <div class="col-right">
              <div class="titulo">5% de descuento en todas tus reservas por ser del Club H10 </div>
              <div class="row">
                ...
                <div class="texto">Darme de alta en el Club H10 con mi reserva</div>
              </div>
              <a href="#" class="btn-link">¿Ya eres socio? Entra en tu cuenta</a>
            </div>
          </div>
        </div>
        ...
        <div class="form">
          <section class="c75__container">
            ...
            <div class="row">
              <div class="col">
                <div class="form-input required">
                  <label class="label">CORREO ELECTRÓNICO* <span>(ESTE CAMPO ES OBLIGATORIO)</span></label>
                  <input class="input" value="" placeholder="" />
                </div>
              </div>
            </div>
                    ...
                    <div class="form-input">
                      ...
                      <div class="select">
                        <select id="standard-select" name="standard-select">
                          <option hidden selected >+34</option>
            ...
            <div class="row">
              <div class="col">
                <div class="form-input">
                  <label class="label">observaciones (no garantizadas)*</label>
              ...
              <div class="col">
                <div class="checkbox-holder">
                  <label class="checkbox">
                    <input type="checkbox" id="i-quiero-regalar">
                    <span class="checkmark"></span> <span>Quiero regalar esta estancia</span>
                  </label>
                </div>
              </div>
              <div class="col text-end">
                <span class="btn"><a href="#">¿Cómo funciona?</a> <img alt='a' src="../../icons/redeem.svg" class="ico" alt="" /></span>
              </div>
            </div>
          </section>

          <section class="c75__container hidden" id="f-quiero-regalar">
            <div class="row">
              <div class="col">
                <div class="text">
                  <p>Rellena los siguientes campos para completar el bono regalo de esta reserva de hotel, que recibirás en tu email para obsequiarloal/la afortunado/a. Esta opción requiere pre-pago.</p>
                </div>
              </div>
            </div>
            <div class="row">
              <div class="col">
                <div class="form-input">
                  <label class="label ajuste_paso_3">Destinatario/a del regalo*</label>
                  <input class="input" value="" placeholder="" />
                </div>
              </div>
              <div class="col">
                <div class="form-input">
                  <label class="label">Persona/grupo que realiza el regalo*</label>
                  <input class="input" value="" placeholder="" />
                </div>
              </div>
            </div>
            <div class="row">
              <div class="col">
                <div class="form-input no-mb">
                  <label class="label">Mensaje a incluir (máximo 200 caracteres)</label>
          ...
          <div class="titulo-top">
            <div class="titulo">MODALIDAD DE PAGO</div>
          </div>
              ...
              <div class="col">
                <div class="radiobox-holder">
                  <label class="radiobox">
                    <input type="radio" name="realizar" checked value="1">
                    <span class="radiomark"></span> Realizar pago en el hotel
                  </label>
                </div>
                <div class="radiobox-holder">
                  <label class="radiobox">
                    <input type="radio" name="realizar" value="2">
                    <span class="radiomark"></span> Realizar pago ahora
                  </label>
                </div>
              </div>
            </div>
            <div class="pago-ahora">
              <div class="row">
                <div class="col">
                  <div class="radiobox-holder">
                    <label class="radiobox">
                      <input type="radio" name="card" checked>
                      <span class="radiomark"></span> <img alt='a' src="../../logos/card-1.png" class="card" alt="" /> <img alt='a' src="../../logos/card-2.png" class="card" alt="" /> <img alt='a' src="../../logos/card-3.png" class="card" alt="" /> <img alt='a' src="../../logos/card-4.png" class="card" alt="" />
                    </label>
                  </div>
                </div>
              </div>
                ...
                <div class="col">
                  <div class="radiobox-holder">
                    <label class="radiobox">
                      ...
                      <span class="radiomark"></span> <img alt='a' src="../../logos/card-5.png" class="card" alt="" />
                    </label>
                  </div>
                </div>
              </div>
            ...
            <div class="row">
              <div class="col">
                <div class="texto legal">
                  <b>Sin gastos de gestión.</b> Los datos de tu tarjeta de crédito son sólo para garantizar tu reserva.
                  <br><br>
                  <b>Cancelación gratuita.</b> Si cancelas o cambias tu reserva hasta las 12:00 horas del día anterior a tu llegada no efectuaremos cargos, excepto tarifas con restricciones.
                </div>
              </div>
            </div>
            <div class="row mb">
              <div class="col">
                <div class="checkbox-holder">
                  <label class="checkbox">
                    <input type="checkbox">
                    <span class="checkmark"></span> <span>He leído y acepto las <a href="#">condiciones de la tarifa</a>, las <a href="https://www.h10hotels.com/es/condiciones-contratacion" target="_blank" >condiciones generales de contratación</a> y el tratamiento de conformidad con lo dispuesto en la <a href="#">política de protección de datos.</a></span>
                  </label>
                </div>
              </div>
            </div>
            <div class="row">
              <div class="col">
                <div class="checkbox-holder">
                  <label class="checkbox">
                    <input type="checkbox">
                    <span class="checkmark"></span> <span>Deseo formar parte del programa de fidelidad Club H10 y acepto las <a href="#">condiciones generales del programa Club H10.</a></span>
                  </label>
                </div>
              </div>
            </div>
