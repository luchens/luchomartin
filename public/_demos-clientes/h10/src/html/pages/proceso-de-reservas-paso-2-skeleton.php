...
<html lang="en">
  <head>
    ...
    <title>Proceso de Reservas - Paso 2 - Skeleton</title>
  ...
  <body class="proceso-de-reservas paso-2 ini-skeleton">
    ...
    <section class="container-fix extra-p-top">
      ...
      <div class="col-left">
        ...
        <div class="extras">
          ...
          <div class="btn-holder">
            <button class="btn-continuar" disabled>CONTINUAR SIN EXTRAS</button>
          </div>
        </div>
      </div>
