...
<html lang="en">
  ...
  <body class="proceso-de-reservas paso-1 ini-buscador-avanzado">
    ...
    <div class="proceso-buscador">
        <!--<div class="container"><a href="/src/html/pages/home.php"><img alt='a' src="../../logos/logo-blue.svg" class="logo"></a></div>-->
      ...
      <div class="col-left">
        ...
        <div class="habitacion-top">
          ...
          <div class="habitaciones-holder">
            ...
            <!--<div class="habitacion">
              <div class="image">
                <img alt='a' src="../../images/image-154.png" class="img" />
              </div>
              <div class="data">
                <div class="titulo">
        ...
        <div class="titulo-top estado-no-continuar">
          <div class="titulo">SELECCIÓN DE HABITACIÓN 1 DE 4</div>
          <div class="texto">(2 adultos, 2 niños)</div>
        </div>

        <div class="habitaciones estado-no-continuar">
          <div class="habitacion">
            <div class="col">
              <div class="col-left">
                <a href="#" class="btn-modal-trigger">
                  <div class="image-holder">
                    <img alt='a' src="../../icons/expandir.svg" class="icon btn-modal" alt="" />
                    <img alt='a' src="../../images/image-154.png" class="image" alt="" />
                  </div>
                </a>
              </div>
              <div class="col-right">
                ...
                <div class="labels">
                  ...
                  <div class="label">VISTAS AL MAR</div>
                  <div class="label">
                    DESAYUNO GRATIS <img alt='a' src="../../icons/i.svg" class="icon" alt="" />
                    <div class="tooltip">
                      <img alt='a' src="../../icons/i.svg" class="ico" alt="" />
            ...
            <div class="tabla">
              <div class="row top">
                ...
                <div class="col wide"><b>Precio noche*</b></div>
        ...
        <div class="sticky">
          ...
          <div class="mi-reserva">
            ...
            <div class="importe">
              ...
              <div class="row">
                <div class="col-left">
                  <div class="texto tooltip_label">Descuento SPRINGH10 (15%) <img alt='a' src="../../icons/i.svg" class="icon" alt="" />
                
                  <div class="tooltip">
                      <img alt="a" src="../../icons/i.svg" class="ico">
                      <div class="texto">1111Desayuno gratis reservando en la web, seleccionando solo alojamiento</div>
                    </div>
              ...
              <div class="row">
                <div class="col-left">
                  <div class="texto tooltip_label">Descuento CLUB H10 (5%) <img alt='a' src="../../icons/i.svg" class="icon" alt="" />
                  <div class="tooltip">
                      <img alt="a" src="../../icons/i.svg" class="ico">
                      <div class="texto">Desayuno gratis reservando en la web, seleccionando solo alojamiento</div>
                    </div>
