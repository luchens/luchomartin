...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="../../../css/style-ficha-habitaciones.css">
  </head>
  <body class="ficha-hotel">
    <?php $include_no = true; include("../sprint-2/c1-topbar-main.php"); ?>
    <div class="c2-c3__container ficha-galeria">
      <?php $include_no = true; include("../modules/c2-c3-ficha-habitaciones.php"); ?>
    </div>
    ...
    <?php $include_no = true; include("../modules/c6-ficha-habitaciones.php"); ?>

    <?php $include_no = true; include("../modules/c27-ficha-habitaciones.php"); ?>
    <?php 
    //$include_no = true; include("../modules/c27-ficha-habitaciones.php"); 
    ?>
