...
<html lang="en">
  ...
  <body class="ficha-hotel">
    ...
    <?php $include_no = true; include("../modules/c6-ficha-perfect-day.php"); ?>
    <?php $include_no = true; include("../modules/c10-ficha-perfect-day.php"); ?>
    <?php $include_no = true; include("../modules/c17-ficha-perfect-day.php"); ?>
