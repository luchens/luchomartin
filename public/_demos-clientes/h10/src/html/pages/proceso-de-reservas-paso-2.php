...
<html lang="en">
  <head>
    ...
    <title>Proceso de Reservas - Paso 2</title>
  ...
  <body class="proceso-de-reservas paso-2">
    ...
    <div class="menu-bottom-mobile">
      ...
      <div class="row">
        <div class="col-left">
          ...
          <div class="precio">1.234 €</div>
        </div>
        <div class="col-right">
          <button type="button" class="btn-continuar">CONTINUAR SIN EXTRAS</button>
        </div>
      </div>
    </div>
    ...
    <div class="menu-mobile">
      <div class="row">
        ...
        <div class="holder">
          <div class="title">AÑADIR EXTRAS</div>
          <div class="text">Reserva. Paso 2/4</div>
        </div>
    ...
    <section class="container-fix extra-p-top">
      ...
      <div class="col-left">
        <div class="extras seleccionados">
          <div class="titulo-top">
            <div class="titulo">TUS EXTRAS</div>
          </div>
          <div class="extra">
            <div class="image">
            ...
            <div class="data">
              <div class="titulo-top"> DESAYUNO GRATIS <div class="texto"></div></div>
              <div class="texto">Desayuno incluido para reservas realizadas en la Web</div>
          ...
          <!--<div class="extra">
            ...
            <div class="data">
              <div class="titulo">PARKING <div class="texto">(2 vehiculos, 4 días)</div></div>
              <div class="texto">Sorpenda a alguien especial con un ramo de flores frescas a su llegada</div>
              <div class="row-bottom">
                <div class="btns">
          ...
          <div class="extra">
            ...
            <div class="data">
              <div class="titulo">Tratamiento en nuestro Despacio Spa <div class="texto">(16 sesiones)</div></div>
              <div class="texto">Sorpenda a alguien especial con un ramo de flores frescas a su llegada</div>
              <div class="row-bottom">
                <div class="btns">
                  <a href="#" class="btn-modificar">Modificar</a>
        ...
        <div class="extras">
          <div class="titulo-top">
            <div class="titulo">PUEDES AÑADIR LOS SIGUIENTES EXTRAS</div>
          </div>

          <div class="extra">
            <div class="image">
              <img alt='a' src="../../images/image-156.png" class="img" />
            </div>
            <div class="data">
              <div class="titulo">RAMO DE FLORES</div>
              <div class="texto">Sorpenda a alguien especial con un ramo de flores frescas a su llegada</div>
              <div class="row-bottom">
                <a href="#" class="btn-detalles">Ver detalles</a>
                <a href="#" class="btn-anadir">AÑADIR por 62€ / DIA</a>
              </div>
            </div>
          </div>
          <div class="extra">
            <div class="image">
              <img alt='a' src="../../images/image-159.png" class="img" />
            </div>
            <div class="data">
              <div class="titulo">TRANSFER</div>
              <div class="texto">Sorpenda a alguien especial con un ramo de flores frescas a su llegada</div>
              <div class="row-bottom">
                <a href="#" class="btn-detalles">Ver detalles</a>
                <a href="#" class="btn-anadir">AÑADIR por 62€ / DIA</a>
          ...
          <div class="extra">
            ...
            <div class="data">
              <div class="titulo">CAVA Y FRUTA</div>
              <div class="texto">A su llegada les esperan CAVA Y FRUTA</div>
              <div class="row-bottom">
                <a href="#" class="btn-detalles cava">Ver detalles</a>
                <a href="#" class="btn-anadir cava">AÑADIR por 62€ / DIA</a>
              </div>
            </div>
          </div>
          <div class="extra">
            ...
            <div class="data">
              ...
              <div class="texto">Sorpenda a alguien especial con un ramo de flores frescas a su llegada</div>
              <div class="row-bottom">
                <a href="#" class="btn-detalles parking">Ver detalles</a>
                <a href="#" class="btn-anadir parking">AÑADIR por 62€ / DIA</a>
              </div>
            </div>
          </div>
          <div class="extra">
            ...
            <div class="data">
              <div class="titulo">Tratamiento en nuestro Despacio Spa</div>
              <div class="texto">Sorpenda a alguien especial con un ramo de flores frescas a su llegada</div>
              <div class="row-bottom">
                <a href="#" class="btn-detalles">Ver detalles</a>
                <a href="#" class="btn-anadir">AÑADIR por 62€ / DIA</a>
          ...
          <div class="btn-holder"><a href="#" class="btn-continuar">CONTINUAR SIN EXTRAS</a></div>
        </div>
      </div>
      ...
      <div class="col-right" id="col-right">
        <div class="sticky">
          ...
          <div class="mi-reserva">
            ...
            <a href="#" class="btn-continuar">CONTINUAR SIN EXTRAS</a>
          </div>
