...
<html lang="en">
  ...
  <body class="ficha-hotel">
    ...
    <div class="c2-c3__container ficha-galeria">
      <?php $include_no = true; include("../modules/c2-c3-ficha-spa.php"); ?>
    </div>
    ...
    <?php $include_no = true; include("../modules/c6-ficha-spa.php"); ?>
    <?php $include_no = true; include("../modules/c10-ficha-spa.php"); ?>
    <?php $include_no = true; include("../modules/c17-ficha-spa.php"); ?>
