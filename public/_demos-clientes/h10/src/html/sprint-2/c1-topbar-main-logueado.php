...
<html lang="en">
  <head>
    ...
    <title>c1-topbar-main-logueado</title>
...
<nav class="topbar-main">
  ...
  <div class="topbar-main__container-right">
    <div class="container-right__mobile">
      ...
      <img src="../../icons/person_-white.svg" class="header__icon-mobile logueado" />
    </div>
...
<!--                  <label for="hotel">HOTEL</label>
        ...
        <li class="js-dropdown dropdown-onclick dropdown-logueado">
          <span class="topbar__links--logueado">
            <span>Hola, nombre</span>
            <img src="../../icons/check-out.svg" class="checkoutsvg" />
          </span>
          <div class="topbar-desplegable__mobile-header">LOG IN<img class="x__mobile" src="../../icons/x.svg" alt="check in icon"></div>
          <div class="dropdown-onclick__content topbar-desplegable__logueado-container">
            <a href="#" class="close"></a>

            <div class="topbar-desplegable__logueado-content">
            <div class="title">¿Quieres cerrar tu sesión?</div>
              <!--<div class="text"></div>-->
                ...
                <div class="c4-01__experiencias-content">
                  ...
                  <div class="c4-01__articles-list acordeon-onclick__submenu">
                    ...
                    <div class="c4-01__vermas c4-01__vermas-experiencias">
                      <hr class="c4-01__hr"><a href="#" class="c4-01__bottom-link experiencias">VER TODAS LAS EXPERIENCIAS</a>
                    </div>
                  </div>
                </div>
              </section>
