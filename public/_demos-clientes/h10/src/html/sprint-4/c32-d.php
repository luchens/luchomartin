      ...
      <div class="row">
        <div class="col">
          <div class="form-input">
            ...
            <input class="input" value="" placeholder="Código postal" />
          </div>
        </div>
      </div>
<!--      <div class="row">
      ...
      <div class="titulo mt">COMENTARIO</div>
      <div class="row">
        <div class="col">
          <div class="form-input">
            <label class="label">Tipo de comentario*</label>
            <div class="select">
              <select id="standard-select" name="standard-select" required>
                <option value="" disabled selected hidden >Queja</option>
                <option value="Option 1">Sugerencia</option>
                <option value="Option 2">Comentario</option>
                <option value="Option 3">Queja/Reclamación</option>
                <option value="Option 4">Agradecimiento</option>
              </select>
            </div>
          </div>
        </div>
