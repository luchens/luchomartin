      ...
      <section class="c51-02__container videos-holder">
        ...
        <div class="items-holder">
          ...
          <div class="item-group-images item-3">
            <div class="video-holder e-click" id="slide-0">
                <div class="ico-play"></div>
                <video id="video" poster="../../images/adults_1.jpg" class="video" c>
            ...
            <div class="image e-click" id="slide-1"><img src="../../images/vacacionales_2.jpg" alt="" /></div>
            <div class="image e-click" id="slide-2"><img src="../../images/vacacionales_3.jpg" alt="" /></div>
          </div>
