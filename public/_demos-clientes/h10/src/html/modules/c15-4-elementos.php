...
<div class="container-fix">
  <section class="c15__container fix-top fix-bottom">
    <div class="hoteles-destacados four-elems">
      <div class="slick-slider-holder">
        <div class="slick-slider">
          <div>
            <div class="hotel-destacado">
              <div class="img-holder"><img src="../../images/image-93.png" class="img" alt=""/></div>
              <div class="data">
          ...
          <div>
            <div class="hotel-destacado">
              <div class="img-holder"><img src="../../images/image-94.png" class="img" alt=""/></div>
              <div class="data">
                <div class="data-content">
          ...
          <div>
            <div class="hotel-destacado">
              <div class="img-holder"><img src="../../images/image-95.png" class="img" alt=""/></div>
              <div class="data">
                <div class="data-content">
                  <div class="titulo">Disfruta del mar</div>
                ...
                <a href="#" class="btn-ver">Hoteles de ciudad</a>
              </div>
            </div>
          </div>
        </div>
