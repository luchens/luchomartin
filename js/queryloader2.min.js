! function e(t, i, s) {
    ...
    4: [function(e, t) {
        ...
        i.prototype.create = function() {
            ...
            this.element.style.height = "100%", this.element.style.marginTop = "0px", this.element.style.backgroundColor = this.barColor, this.element.style.position = "absolute", this.element.style.top = "0px", this.setTransitionTime(100)
